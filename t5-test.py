...
model_path = "./method-test-generator-t5"
...
def tokenize_function_test(examples):
    return tokenizer(examples["src_fm"], padding="max_length", truncation=True, max_length=1024)
...
with open("test_results_t5.txt", "w") as f:
    for line in results:
        f.write(line + "\n")

print("Testing complete. Results saved to 'test_results_t5.txt'.")
